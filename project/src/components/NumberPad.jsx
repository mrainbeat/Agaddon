...
function NumberPad({
  ...
  return (
    <div className="-mx-5 mt-4 rounded-t-3xl bg-[#F1F1F5] px-4 pt-3 pb-2">
      {actionLabel && (
        <button
          type="button"
          className="mb-3 flex w-full items-center justify-center gap-[10px] self-stretch rounded-t-lg rounded-b-none bg-[#FF795B] px-4 py-3 text-[15px] font-bold text-white disabled:bg-line-soft disabled:text-ink-muted"
        ...
        {KEYS.map(({ key, letters }, i) => {
          ...
          return (
            ...
            >
              ...
              <span className="text-[9px] font-medium tracking-widest text-ink-muted">
                {letters}
              </span>
            </button>
          );
